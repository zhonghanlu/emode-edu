...
INSERT INTO `auth_permission` (`id`, `parent_id`, `menu_name`, `menu_path`, `menu_url`, `permissions`, `menu_type`, `icon`, `sort`, `del_flag`) VALUES (123, 7, '用户管理', 'user', '/system/user/index', 'system:user:list', 'Menu', 'theme', 1, 1);
INSERT INTO `auth_permission` (`id`, `parent_id`, `menu_name`, `menu_path`, `menu_url`, `permissions`, `menu_type`, `icon`, `sort`, `del_flag`) VALUES (124, 7, '角色管理', 'role', '/system/role/index', 'system:role:list', 'Menu', 'example', 2, 1);
...
INSERT INTO `auth_permission` (`id`, `parent_id`, `menu_name`, `menu_path`, `menu_url`, `permissions`, `menu_type`, `icon`, `sort`, `del_flag`) VALUES (128, 7, '日志管理', 'log', '', '', 'Menu', '404', 6, 1);
